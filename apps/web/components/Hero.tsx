    ...
    <section className="relative h-[calc(100vh-80px)] flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 md:space-y-8 text-center lg:text-left">
          ...
          {/* CTA Button */}
          <div className="inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-8 py-4 sm:py-5 rounded-full transition-all hover:scale-105 cursor-pointer"
            style={{
          ...
          >
            <Sparkles className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: 'var(--color-sage-green)' }} />
            <span style={{ color: 'var(--color-sage-green)' }}>
              Eco assistant nouvelle génération
            </span>
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: 'var(--color-sage-green)' }} />
          </div>
        </div>
  ...
  return (
    <div className="relative w-full max-w-md">
      <svg viewBox="0 0 400 400" className="w-full h-auto">
        ...
        <circle cx="200" cy="200" r="149" fill="none" stroke="#3a1e14" strokeWidth="2" />

        {/* Right eye */}
        <g>
          <circle cx="230" cy="180" r="52" fill="#fff" />
          <ellipse cx="235" cy="175" rx="33" ry="43" fill="#3a1e14" transform="rotate(-31 235 175)" />
          {/* Eye reflection */}
          <path d="M 220 175 Q 235 177 242 183" stroke="#fff" strokeWidth="3" fill="none" strokeLinecap="round" />
          {/* Pupil highlights */}
        ...
        <g>
          ...
          <ellipse cx="175" cy="179" rx="33" ry="43" fill="#3a1e14" transform="rotate(-31 175 179)" />
          {/* Eye reflection */}
          <path d="M 160 179 Q 175 181 182 187" stroke="#fff" strokeWidth="3" fill="none" strokeLinecap="round" />
          {/* Pupil highlights */}
        ...
        {/* Mouth */}
        <ellipse cx="200" cy="243" rx="10.5" ry="17" fill="#3a1e14" transform="rotate(-0.16 200 243)" />
        ...
        <g transform="translate(320, 140)">
          ...
          <circle cx="0" cy="0" r="52" fill="none" stroke="#3a1e14" strokeWidth="1" />
